var previousDayMs = new Date().getTime() - 156400000; // previous day in milliseconds 86400000 = 1 Day
...
$(document).ready(function() {
  ...
  function searchDateByRover(roverName) { // function that sets up search bar for rover that is selected from top of the html page. Also clears array & div of old images and html and inserts new html and images into page for the selected rover
    ...
    .fail(function() { // error handling for any searchbox submission errors by users
      errorMessage.innerHTML = "Images are not available for the date entered.<br><br>or<br><br>The date format is incorrect<br>Use this format:<br>YYYY-MM-DD<br><h4>Y = Year,  M = Month,  D = Day</h4>";
    })
  ...
  document.getElementById("curiosity").onclick = function(e) { // Loads latest images and enables image search by date for Curiosity rover
      ...
      switchRover("curiosity", searchDate); // function pulls images from Curiosity rover
  ...
  document.getElementById("opportunity").onclick = function(e) { // Loads latest images and enables image search by date for Opportunity rover
      ...
      switchRover("opportunity", searchDate); // function pulls images from Opportunity rover
  ...
  document.getElementById("spirit").onclick = function(e) { // Loads latest images and enables image search by date for Spirit rover
      ...
      switchRover("spirit", "2010-02-26"); // function pulls images from Spirit rover. 2010-02-26 was last date images were available from this rover
